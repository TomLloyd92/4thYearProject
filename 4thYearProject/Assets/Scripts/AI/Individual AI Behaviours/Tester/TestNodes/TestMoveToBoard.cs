...
public class TestMoveToBoard : Node
{
    //Private Vars
    ...
    public override state Evaluate()
    {
        ...
        meetingPoints = GameObject.FindGameObjectWithTag("TestMeeting").GetComponent<KanBanMeetingPoints>();
        ...
        for (int i = 0; i < meetingPoint.Length; i++)
        {
            ...
            {
                distanceToPositions = Vector3.Distance(tester.transform.position, meetingPoint[i].transform.position);
